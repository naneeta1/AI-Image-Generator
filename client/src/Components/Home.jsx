...
import { Card,Loader,Field } from '../form_components';
  ...
  return (
   <section className='max-w-7xl mx-auto'>
    <div>
        ...
        <p className='mt-2 text-[#666e75] text-[146x] max-w-[500px]'>Browse Through a collection of 
        imaginative visually stunning images generated by DALL-E-AI</p>
    </div>
    <div className='mt-16'>
        <Field />
    </div>
